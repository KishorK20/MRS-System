...
logo = Image.open(r'Images/logo2.png')
kishor = Image.open(r'Images/kishork.png')
dhruv = Image.open(r'Images/dhruv.png')
subhajit = Image.open(r'Images/subhajit.png')
rimi = Image.open(r'Images/rimi.png')
ankush = Image.open(r'Images/ankush.png')
anna = Image.open(r'Images/anna.png')
...
#--if "MR System " is selected --- its operational code[the main system of project]
    ...
    def fetch_poster(movie_id): #--- Function made to fetch the poster of movies 
        ...
        url = "https://api.themoviedb.org/3/movie/{}?api_key=03f53b7ec3e40822e326e9a21d10e856&language=en-US".format(movie_id)
    ...
    with st.container():
        ...
        with col1:
            ...
            st.write("FRAMEWORK :  Streamlit [Python's Web-based application development framework] & Elements of Bootstrap")
            st.write("##")
        with col2:
